...
function ie(e, t) {
	...
	return e.childrenIds.length && (n.children = e.childrenIds.map((e) => ie(t[e], t))), n;
}
function ae(e) {
	let t = {}, n = null;
	return e.forEach((e) => {
...
function oe(e, t) {
	...
	let i = [];
	return P(r, n, i, { n: Date.now() }, t.toDagreEdge), {
...
function le(e, t, n) {
	...
	return e.forEach((e) => {
		let a = e.getChildren();
		if (a) {
			let { width: r, height: i } = e.getOptions(), o = ce, s = ce, c = i + n, l, u, d = n;
			if (a.length) {
				let { widths: i, heights: o } = le(a, t, n);
...
function ue(e, t, n) {
	...
	if (i?.length) {
		let { height: a } = e.getOptions(), o = a + n, s = ce;
		if (M.isRoute(e.getType())) {
			let e = s;
			i.forEach((r) => {
				r.setPosition({
					x: e,
					y: o
				}), e = e + r.getWidth() + t, r.getChildren()?.length && ue(r, t, n);
			});
		} else {
			let e = o;
			i.forEach((i) => {
				i.setPosition({
					x: (r - i.getWidth()) / 2,
					y: e
				}), e = e + i.getHeight() + n, i.getChildren()?.length && ue(i, t, n);
			});
		}
	}
}
...
function pe(e, t, n) {
	let r = new fe(e);
	return n[e.id] = r, !e.folded && e.childrenIds.length && (r.children = e.childrenIds.map((e) => pe(t[e], t, n))), r;
}
function me(e) {
	let t = {}, n = {}, r = null;
	e.forEach((e) => {
	...
	let i = pe(r, t, n);
	return le([i], 30, 62), ue(i, 30, 62), de(i), n;
}
var F = {
	clear: "清空",
	delete: "删除",
...
var ye = {
	...
	defaultData: {
		meta: {
			name: "unkown",
			width: _e.nodeDefaultSize.width,
			height: _e.nodeDefaultSize.height
		},
		props: {}
	},
	executor: {}
...
function be(e) {
	return ge[e] || console.error(`node: ${e} not found!`), ge[e] || ye;
}
function xe(e) {
	_e.pureRunner?.setShareData({ $: e });
}
function Se(e, t) {
	if (!ge[e]) {
		t.icon ||= ve;
		let n = t.defaultData.meta;
		n.width ||= _e.nodeDefaultSize.width, n.height ||= _e.nodeDefaultSize.height, ge[e] = t;
	}
	return ge[e];
}
function we({ lang: e, nodeDefaultSize: t, pureRunner: n }) {
	e && Object.assign(F, e), t && (_e.nodeDefaultSize = t), n && (_e.pureRunner = n);
}
async function Ee(e, t, n) {
	...
	return r.forEach((r) => {
		...
		let c = e[r];
		ge[c] || a.push(n(c).then((e) => {
			let t = { ...e };
			if (e.validate && (_e.pureRunner.initFunction(`${c}@validate`, e.validate.toString()), t.validate = (t, n) => _e.pureRunner.runFunction(c, [t, n], e.collaborationApply ? ["$"] : void 0)), e.propsRender && (_e.pureRunner.initFunction(`${c}@propsRender.in`, e.propsRender.in.toString()), _e.pureRunner.initFunction(`${c}@propsRender.out`, e.propsRender.out.toString()), t.propsRender = {
				in: (e) => _e.pureRunner.runFunction(`${c}@propsRender.in`, [e]),
				out: (e) => _e.pureRunner.runFunction(`${c}@propsRender.out`, [e])
			}), e.outputForm) {
				let { toolsFilter: n, editableFilter: r } = e.outputForm;
				t.outputForm = { ...e.outputForm }, n && (_e.pureRunner.initFunction(`${c}@outputForm.toolsFilter`, n.toString()), t.outputForm.toolsFilter = (e, t) => _e.pureRunner.runFunction(`${c}@outputForm.toolsFilter`, [e, t])), r && (_e.pureRunner.initFunction(`${c}@outputForm.editableFilter`, r.toString()), t.outputForm.editableFilter = (e, t) => _e.pureRunner.runFunction(`${c}@outputForm.editableFilter`, [e, t]));
			}
			return Se(c, t), c;
		}));
	}), await Promise.all(a), {
...
var $t = class {
	...
	push(e) {
		this.running || this.lock || (this.lock = setTimeout(() => {
			this.lock = 0;
		}, N.historyLock), this.undoList.unshift(e), this.redoList.length = 0, this.undoList.length > this.limit && (this.undoList.length = this.limit), this.graph.dispatch("historyChanged", this.getState()));
	}
	undo() {
...
var en = class {
	...
	doSave = () => {
		if (this.graph.hasBusy()) {
			setTimeout(this.doSave, N.saveToApi);
			return;
		}
		if (this._data) {
			let e = this._data;
	...
	save = () => {
		if (this._state !== "saving") return this._state = "saving", this.graph.dispatch("saverChanged", this._state), setTimeout(this.doSave, N.saveToApi), new Promise((e, t) => {
			this._result = {
				resolve: e,
				reject: t
			};
...
var tn = class extends Kt {
	...
	updateNodeData(e, t, n) {
		this.#i ||= {
			timer: setTimeout(this.#s, N.nodeDataUpdate),
			nodes: {}
		};
		let r = this.#i.nodes;
		r[e] || (r[e] = {});
	...
	updateNodeError(e, t) {
		this.#r ||= {
			timer: setTimeout(this.#c, N.nodeDataUpdate),
			nodes: {}
		};
		let n = this.#r.nodes;
		n[e] || (n[e] = {});
...
var on = class extends Kt {
	...
	setMockState(e) {
		if (!M.mockAble(this.getType())) return F.nodeCannotBeDisable;
...
var sn = class extends tn {
	...
	uploadNodeData(e) {
		let t = this._dataMap[e];
		if (!t) throw he(F.nodeNotExist, { node: e });
...
var ln = class extends sn {
	...
	verifyNewNodeId(e) {
		return /^[a-z$][\w$]*$/i.test(e) ? this._dataMap[e] ? he(F.nodeHasExist, { node: e }) : "" : F.nodeIdFormat;
	}
	parseDeleteIds(e) {
		let t = {};
	...
	toInspectCode() {
		let e = [], { nodes: t } = ae(this._graphData.nodes), n = t.children, r = n.shift();
	...
	resetNodeId(e, t) {
		if (e === "start" || e === "end" || e === "flow") return F.idCannotBeModify;
		let n = this._dataMap[e];
		if (!n) return he(F.nodeNotExist, { node: e });
	...
	applyTrigger(e, t) {
		return Ee(t, this._graphData.sources, this._hooks.onImportNode.bind(this._hooks)).then(async ({ sources: t, replaced: n }) => {
			...
			return this.updateNodes(this._graphData.nodes, l.concat([c]), { validate: !0 }), this._triggerLayout.setNodes(this._graphData.triggers), setTimeout(() => this.reselect(c.id), N.nodeDataUpdate + 50), n;
		});
	}
	applyNode(e, t, n, r) {
		return Ee(r, this._graphData.sources, this._hooks.onImportNode.bind(this._hooks)).then(({ sources: r, replaced: i }) => {
			...
			return this.updateNodes(p, this._graphData.triggers, { validate: !0 }), this._flowLayout.addNodes(f, l.getData()), f.length === 1 && setTimeout(() => this.reselect(f[0].id), N.nodeDataUpdate + 50), i;
		});
	}
	toClipboard(e, t) {
		...
		return J.clipboard.write(a).then(() => J.message.success(F.alreadyToClipboard)), a;
	}
	async pasteFromClipboard(e, t) {
		let n = await J.clipboard.read(), r = n ? JSON.parse(n) : null;
		if (r?.namespace !== "baseflow") throw Error(F.clipboardIsEmpty);
...
var fn = class {
	...
	onBeforeSelect(e) {
		if (e.getType() === j.Flow) throw Error(F.notAllowedToSelectFlowNode);
	}
	onBeforeReselect(e) {
		if (e.find((e) => e.getType() === j.Flow) && e.length !== 1) throw Error(F.notAllowedToSelectFlowNode);
	}
	...
	onBeforeApplyNodes(e, t, n) {
		...
		if (t === "behind" && (o === j.End || i.isDefaultBranch())) throw Error(he(F.notAllowedToAddBehind, { node: a }));
		if (!s.isContainer()) throw Error(he(F.notAllowedToAddChild, { node: l }));
		for (let e of n) {
			let n = e.tag || "", r = this.getGraph().getNodeConfigByTag(n).type;
			if ((r === j.Start || r === j.End) && t !== "replace") throw Error(F.startOrEndCanOnlyBeReplace);
			if (c === j.Choice && r !== j.Branch || c === j.Parallel && r !== j.Thread) throw Error(he(F.onlySameBranchCanBeAdd, { node: l }));
			if (r === j.Branch && c !== j.Choice || r === j.Thread && c !== j.Parallel) throw Error(he(F.notAllowedToAddBranch, { node: l }));
		}
	}
	onBeforeDeleteNodes(e, t, n) {
		for (let e in t) {
			let t = this.getGraph().getNodeById(e);
			if (!t) throw Error(he(F.nodeNotExist, { node: e }));
			if (!M.deleteAble(t.getType())) throw Error(he(F.notAllowedToDelete, { node: t.getName() }));
			if (t.isDefaultBranch()) throw Error(he(F.notAllowedToDeleteDefaultBranch, { node: t.getName() }));
		}
		for (let e in n) {
			let t = this.getGraph().getNodeById(e), r = n[e];
			if (t.isRoute() && t.getChildrenLength() - Object.keys(r).length < 2) throw Error(he(F.keepAtLeast2Branches, { node: t.getName() }));
		}
	}
	onBeforeMoveNodes(e, t, n, r, i) {
		let a = this.getGraph().getNodeById(e), o = t === "inside" ? a.getId() : a.getParentId();
		if (n[e]) throw Error(he(F.notAllowedToMoveThat, { node: a.getName() }));
		for (let e in r) {
			let t = this.getGraph().getNodeById(e);
			if (!t) throw Error(he(F.nodeNotExist, { node: e }));
			if (t.getType() === j.Start || t.getType() === j.End) throw Error(he(F.notAllowedToMove, { node: t.getName() }));
			if (t.isDefaultBranch()) throw Error(he(F.notAllowedToMoveDefaultBranch, { node: t.getName() }));
		}
		for (let n in i) {
			let r = this.getGraph().getNodeById(n), a = i[n];
			if (o !== n) {
				if (console.log("跨级移动", a), r.isRoute() && r.getChildrenLength() - Object.keys(a).length < 2) throw Error(he(F.keepAtLeast2Branches, { node: r.getName() }));
...
var ci = (0, import_react.forwardRef)((e, t) => {
	let n = vr(), [r] = (0, import_react.useState)(Ut.createUID()), i = (0, import_react.useRef)(null), a = (0, import_react.useRef)(""), { style: o, variant: s, nativeRender: l, optional: d, nativeRenderOptions: g, onChange: y, sourceType: b, error: x, hideError: S, dataTypeEditable: C, context: w = "", runtime: T = "expression", dataType: E = I.String } = e, ee = e.variableFilter, D = T === "script" ? L.Expression : e.dataSource, te = b === "mapping" ? e.placeholder || R.loopContextPrompt : e.placeholder, O = b === "mapping" || e.hideIcon, [k, A] = (0, import_react.useState)(!1), [ne] = (0, import_react.useState)(new Lr()), [j, re] = (0, import_react.useState)(""), M = Z((e) => {
	...
	}, [e.height]), ie = (0, import_react.useMemo)(() => K.classNames("ͼbaseflow-SuperInput", e.className, s, {
		active: k,
		hideIcon: O,
		hasError: !S && (x || j)
	}), [
		...
		s,
		k
	]), ae = (0, import_react.useRef)(void 0);
	(0, import_react.useMemo)(() => {
		ae.current = E;
	}, [E]);
	let P = (0, import_react.useMemo)(() => zr(e.value, D), [e.value, D]), oe = Z((t) => {
		if (P.mode !== t) {
			let { source: n, text: r } = Br(P.code, t, P, D, b);
		...
		if (P.code !== t) {
			let { source: n, text: r } = Br(t, P.mode, P, D, b);
			if (n !== e.value?.source || r !== e.value?.text) {
				...
				C && n === L.Variable && ae.current && (e.type = ae.current), y?.(e);
			}
		}
	}), ce = Z((e) => {
		y?.({
	...
	}), le = (0, import_react.useCallback)((e, t) => {
		ae.current = t, i.current?.insertVariable(e);
	}, []), ue = Z(() => P.mode), de = Z(() => E), fe = Z(() => w), pe = Z(() => T), me = Z(() => ee), F = Z(() => e.value), he = (0, import_react.useCallback)(() => a.current, []), ge = Z(() => e.brand), _e = (0, import_react.useCallback)((e) => {
		e || (a.current = ""), A(e);
	...
	return (0, import_react.useEffect)(() => {
		...
		className: K.classNames(ie, P.mode),
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				style: N,
				onClick: ye,
				children: P.mode === "complex" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Vr, {
					onChange: se,
					text: P.code,
...
var Ia = (0, import_react.memo)(({ locale: e = "en-US", lang: t, nodeDefaultSize: n, widgets: r, monacoEditorUrl: i, pureRunnerUrl: a, expressionUtils: o, children: s }) => ((0, import_react.useMemo)(() => {
	t && (Object.assign(Fa, t), Bt({ lang: t })), we({ pureRunner: Na({ workerURL: a || "./pureRunner.worker.js" }) }), e && Bt({ locale: e }), n && we({ nodeDefaultSize: n }), i && Bt({ monacoEditorUrl: i }), o && Bt({ expressionUtils: o }), r && Wt(r), r && Ir(r);
}, []), (0, import_react.useEffect)(() => {
	Ut.createValidateProvider(), console.log(J), Object.assign(Pa, J, Q);
}, []), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [s, /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Fr, {})] })));
...
var Ya = (0, import_react.memo)(({ graph: e, initialLayoutData: t }) => {
	let [n, r] = (0, import_react.useState)(t), i = Z(() => n), a = Z((e) => {
		...
		J.clipboard.write(JSON.stringify(n)).then(() => J.message.success(F.alreadyToClipboard));
	});
	return (0, import_react.useEffect)(() => {
		let t = {
			getData: i,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					!m && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						onClick: () => n !== "in" && r("in"),
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: g ? F.listen : F.input })
					}),
					!m && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: K.classNames("tab", { on: n === "out" }),
						onClick: () => n !== "out" && r("out"),
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: g ? F.mapping : F.output })
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: K.classNames("tab", { on: n === "log" }),
						onClick: () => n !== "log" && r("log"),
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: F.log })
					}),
					!m && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, {
						className: "link upload",
						name: Y.CloudDownload,
						onMouseEnter: (e) => Q.tooltip({
							content: F.downloadConfig,
							target: e.target
						}),
						onClick: C
					}),
...
var eo = (0, import_react.memo)(({ node: e, nodeData: t }) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [t.meta.collaboratorMessages && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "alert",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, { name: Y.Info }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: F.inputSchemaChanged })] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Q.Button, {
			size: "small",
			type: "primary",
			onClick: a,
			children: R.ButtonOk
	...
	if (r) {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "title on",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: F.currentNodeIsDisabled }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Q.Switch, {
						value: !1,
						checkedChildren: F.enableNode,
						unCheckedChildren: F.enableNode,
						onChange: o
					})]
				}), e.type !== j.Trigger && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "desc",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: F.currentNodeIsDisabledDesc }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Q.Switch, {
						value: r !== !0,
						checkedChildren: F.mockOutput,
						unCheckedChildren: F.mockOutput,
						onChange: s
					})]
				})]
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: F.currentNodeIsDisabledDesc }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Q.Switch, {
					value: !1,
					checkedChildren: F.disableNode,
					unCheckedChildren: F.disableNode,
					onChange: a
				})]
			})
		})
		...
		children: [
			...
			s ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					...
					className: "time",
					children: `(${F.executionTime}: ${s.time}s)`
				}) : null] })]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "console",
...
var ao = (0, import_react.memo)(({ node: e, nodeData: t, options: n }) => {
	...
	return r ? n?.editable ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ea, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, { name: Y.Empty }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: F.noDataPrompt })]
	});
});
var oo = (0, import_react.memo)(({ node: e, graph: t }) => {
	...
	return (0, import_react.useEffect)(() => {
		...
		children: e && n && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Za, {
			...
			children: [
				s === "in" && d && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: n.id }),
...
var so = (0, import_react.memo)(({ graph: e, onSubmit: t }) => {
	let [n, r] = (0, import_react.useState)(), [i, a] = (0, import_react.useState)(!1), o = n?.list, s = (0, import_react.useCallback)((n) => {
		...
		J.clipboard.write(n?.commitId || "").then(() => J.message.success(F.alreadyToClipboard));
	}, [n?.commitId]);
	return (0, import_react.useEffect)(() => {
...
var lo = (e, t) => {
	if (!t) return { name: F.output };
};
var uo = (0, import_react.forwardRef)(({ graph: e, data: t, onClose: n }, r) => {
	let [i, a] = (0, import_react.useState)(!!t.running), o = (0, import_react.useRef)(void 0), [s] = (0, import_react.useState)(() => e.getNodeDataMaps()), [c, l] = (0, import_react.useState)(() => ae(e.getGraphData().nodes).nodes), [d, y] = (0, import_react.useState)(""), b = t.logs, x = t.running, S = b.nodes[d], C = Object.values(b.nodes).filter((e) => e.status === "running"), w = Z((e) => {
		...
		l(i), b.result.status !== "running" && (b.result.status === "error" ? J.message.error(F.executionCompleted) : J.message.success(F.executionCompleted), a(!1));
	}), te = Z((e) => {
		let t = z.produce(c, (t) => {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "text",
					children: S.status.toUpperCase()
				}), S.time ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: `${F.executionTime}: ${S.time}s` }) : null]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "console",
				children: [
...
var ho = (0, import_react.memo)(({ graph: e }) => {
	let [t, n] = (0, import_react.useState)(e.getStatus()), r = (0, import_react.useRef)(null), [i, a] = (0, import_react.useState)(), [o, s] = (0, import_react.useState)(), [c, l] = (0, import_react.useState)("development"), [d, f] = (0, import_react.useState)(), p = (0, import_react.useRef)(null), y = Z((e) => {
		...
		if (t === "error") {
			J.message.error(F.graphErrorsPrompt), e.setCenterNode();
			return;
		}
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					t === "error" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, {
						...
						onMouseEnter: (e) => Q.tooltip({
							content: F.graphErrorsPrompt,
							target: e.target
						})
					}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, {
						className: "item info",
						name: Y.Info,
						onClick: () => J.message.success(F.noErrors)
					}),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, {
								name: Y.Help,
								onMouseEnter: (e) => Q.tooltip({
									content: F.envModeTips,
									target: e.target
								})
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: `${F.envMode}:` }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Q.Select, {
...
var Oo = (0, import_react.forwardRef)((e, t) => {
	...
	(0, import_react.useMemo)(() => {
		if (r) {
			...
			c &&= e ? ht.produceDeviceAndOutput(c, (t, { isDevice: n }) => {
				let r;
				r = n ? (N === "all" ? void 0 : t.data !== N) || void 0 : e(t) || void 0, t.disabled !== r && (t.disabled = r);
			}) : ht.produceDeviceAndOutput(c, (e, { isDevice: t }) => {
				let n;
				n = t && (N === "all" ? void 0 : e.data !== N) || void 0, e.disabled !== n && (e.disabled = n);
			}), s(c);
	...
	let ie = (0, import_react.useMemo)(() => r ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
	...
	return (0, import_react.useMemo)(() => {
		...
		ae && (a.current = !1, w("output"), E(""), l(""), f(void 0), s(void 0), b(et.getConstants()), S(et.getUtils()));
	}, [ae]), (0, import_react.useEffect)(() => {
		let e = [];
		...
		ref: ee,
		children: [ie, /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
var jo = (0, import_react.memo)(({ className: e, initialData: t, graphHooks: n, onShowCreater: r, options: i, onInit: a, onClick: o }) => {
	let [s, c] = (0, import_react.useState)(), [l, d] = (0, import_react.useState)(t.triggers), [f, g] = (0, import_react.useState)(), [y, b] = (0, import_react.useState)([]), [x, S] = (0, import_react.useState)(), [C, w] = (0, import_react.useState)(), T = (0, import_react.useRef)(null), E = s?.graph.getState(), [ee, D] = (0, import_react.useState)(), te = Z((e) => dn(t, T.current, r, n, i || {}, e).then((e) => {
		...
		if (s && f) {
			...
			return i || (e === "dagre" ? i = xa(r, s.graph) : e === "code" ? i = ae(r) : e === "dsl" && (i = an.graphToJson(s.graph.getGraphData()))), {
				layout: e,
				graph: s.graph,
				initialLayoutData: i,
				initialViewport: n || {
