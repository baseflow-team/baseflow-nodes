import { type NodeNavigation, type NodeSetup, useEvent } from "@baseflow/node-runtime-react";
import type { FC } from "react";
import { memo, useState } from "react";
import InputForm from "./components/InputForm";
import OutputForm from "./components/OutputForm";
import Readme from "./components/Readme";
import type { InternalProps, NodeProps } from "./model";
...
const Component: FC<{ setup: NodeSetup<NodeProps> }> = ({ setup }) => {
  ...
  const updateInternalProps = useEvent((newProps: Partial<InternalProps>) => {
    setInternalProps({ ...internalProps, ...newProps });
  });
    ...
    <div>
      {currentTab === "input" && (
        <InputForm
          ...
          updateInternalProps={updateInternalProps}
          updateNodeMeta={updateNodeMeta}
          getVariableSchema={getVariableSchema}
        />
      )}
